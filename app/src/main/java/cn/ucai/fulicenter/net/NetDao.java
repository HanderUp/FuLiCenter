...
public class NetDao {
    public static void downloadNewGoods(Context context,int catId, int pagId, OkHttpUtils.OnCompleteListener<NewGoodsBean[]> listener){
    ...
    public static void downloadCategoryGoods(Context context,int catId, int pagId, OkHttpUtils.OnCompleteListener<NewGoodsBean[]> listener){
        OkHttpUtils<NewGoodsBean[]> utils = new OkHttpUtils<>(context);
